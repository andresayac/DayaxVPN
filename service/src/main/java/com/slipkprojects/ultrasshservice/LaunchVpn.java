	...
	implements DialogInterface.OnCancelListener
{
	...
	protected void startVpnFromIntent() {
        ...
        if (Intent.ACTION_MAIN.equals(action)) {
			...
			launchvpn = (FrameLayout) findViewById(R.id.launchvpnFrameLayout);
            ...
            if (resultCode == Activity.RESULT_OK) {
				...
				if (!TunnelUtils.isNetworkOnline(this)) {
				   ...
				   toastutil.showErrorToast(getString(R.string.error_proxy_invalid));
        			...
        			startLW.setComponent(new ComponentName(this, "com.slipkprojects.sockshttp" + ".activities.ConfigGeralActivity"));
