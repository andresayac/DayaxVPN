...
public class SocksHttpCore {
    ...
    private void createNotificationChannels() {
        ...
        NotificationChannel mChannel = new NotificationChannel(SocksHttpService.NOTIFICATION_CHANNEL_BG_ID, name, NotificationManager.IMPORTANCE_MIN);
        ...
        mChannel = new NotificationChannel(SocksHttpService.NOTIFICATION_CHANNEL_NEWSTATUS_ID, name, NotificationManager.IMPORTANCE_LOW);
